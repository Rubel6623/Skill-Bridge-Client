  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
        ...
        <p className="font-black text-gray-400 dark:text-white/40 tracking-[0.3em] uppercase text-[10px]">Scanning Knowledge Graph...</p>
      </div>
    )
  }
    ...
    <div className="p-8 space-y-12 bg-transparent text-gray-900 dark:text-white animate-in fade-in duration-700">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-white/50 text-lg mt-3 font-medium">Moderate all educational modules offered on the platform.</p>
        </div>
      ...
      {subjects.length > 0 ? (
            ...
            <div key={subject.id} className="bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-8 backdrop-blur-xl shadow-2xl hover:border-orange-500/30 transition-all group relative overflow-hidden flex flex-col h-full">
              ...
              <div className="flex items-start justify-between mb-8 relative z-10">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="h-10 w-10 p-0 rounded-xl hover:bg-gray-100 dark:hover:bg-white/10 transition-all">
                      <MoreVertical size={18} className="text-gray-300 dark:text-white/20 group-hover:text-gray-900 dark:group-hover:text-white" />
                    </Button>
                  </DropdownMenuTrigger>
              ...
              <div className="space-y-6 flex-1 relative z-10 flex flex-col">
                <div className="flex-1">
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white tracking-tighter uppercase leading-none mb-3 group-hover:text-orange-500 transition-colors">
                    {subject.title}
                  </h3>
        ...
        <div className="text-center py-32 bg-gray-50 dark:bg-white/[0.02] border-2 border-dashed border-gray-200 dark:border-white/10 rounded-[3rem] flex flex-col items-center gap-8 shadow-lg dark:shadow-2xl">
           <div className="w-24 h-24 bg-white dark:bg-white/5 rounded-full flex items-center justify-center border border-gray-100 dark:border-white/5">
              <BookOpen size={40} className="text-gray-200 dark:text-white/10" />
           </div>
           <div>
             <h3 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight uppercase">Knowledge Gap</h3>
             <p className="text-gray-400 dark:text-white/40 mt-3 font-medium max-w-sm mx-auto italic">No subjects matching the current identification criteria were found in the registry.</p>
           </div>
           <Button 
