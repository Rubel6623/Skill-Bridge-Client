...
export default function Error({
  ...
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center p-8 bg-transparent text-gray-900 dark:text-white relative overflow-hidden font-mono translate-y-[-5%]">
      ...
      <div className="relative mb-14 group scale-90">
        ...
        <div className="relative bg-white dark:bg-zinc-900 border border-red-500/50 p-6 rounded-3xl shadow-2xl shadow-red-500/20">
      ...
      <div className="max-w-xl text-center space-y-6 relative z-10">
        <div className="space-y-3">
           <h1 className="text-2xl md:text-3xl font-black uppercase tracking-tighter text-gray-900 dark:text-white/90">
           ...
           <div className="flex justify-center gap-2 items-center opacity-30 select-none">
             <Terminal size={12} className="text-gray-500 dark:text-zinc-500" />
             <p className="text-[10px] uppercase font-black tracking-[0.4em] text-gray-500 dark:text-zinc-500">HUB Segment: Secure Dashboard</p>
           </div>
        </div>
        
        <p className="text-gray-500 dark:text-zinc-500 font-medium leading-relaxed italic text-xs md:text-sm max-w-md mx-auto">
        ...
        <div className="bg-gray-100 dark:bg-zinc-950/80 border border-gray-300 dark:border-zinc-800 p-5 rounded-2xl font-mono text-left space-y-2 group/log max-w-lg mx-auto shadow-inner relative overflow-hidden backdrop-blur-md">
           ...
           <div className="h-px bg-gray-300 dark:bg-zinc-800 w-full mb-2" />
           <p className="text-[10px] text-gray-700 dark:text-zinc-300 leading-relaxed font-mono line-clamp-2">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 pt-8">
          ...
          <Link href="/dashboard">
            <button className="flex items-center gap-2 text-gray-500 dark:text-zinc-500 hover:text-gray-900 dark:hover:text-white font-black uppercase tracking-[0.2em] text-[10px] transition-all group">
