...
export default function AboutUsPage() {
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-[#0a0a0f] text-gray-900 dark:text-white">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 dark:text-zinc-400 max-w-3xl mx-auto leading-relaxed mb-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/register?role=tutor">
              <button className="w-full sm:w-auto bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-900 dark:text-white font-bold py-4 px-8 rounded-full transition-all border border-gray-300 dark:border-white/10 flex items-center justify-center gap-2">
                Become a Tutor
              </button>
            </Link>
          </div>
      ...
      {/* Stats Section */}
      <section className="py-20 border-y border-gray-200 dark:border-white/5 bg-white dark:bg-white/[0.01]">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            <div>
              <h3 className="text-4xl md:text-5xl font-extrabold text-orange-500 mb-2">500+</h3>
              <p className="text-gray-500 dark:text-zinc-500 font-medium">Verified Tutors</p>
            </div>
            <div>
              <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-2">10k+</h3>
              <p className="text-gray-500 dark:text-zinc-500 font-medium">Active Students</p>
            </div>
            <div>
              <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-2">50+</h3>
              <p className="text-gray-500 dark:text-zinc-500 font-medium">Subjects Available</p>
            </div>
            <div>
              <h3 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-2">4.9/5</h3>
              <p className="text-gray-500 dark:text-zinc-500 font-medium">Average Rating</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 space-y-8">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/5 flex items-center justify-center shrink-0 border border-black/10 dark:border-white/10 shadow-sm dark:shadow-none">
                    <ShieldCheck className="text-orange-500" size={24} />
                  </div>
                  <div>
                    <h4 className="text-xl font-bold mb-1">Vetted Experts</h4>
                    <p className="text-gray-500 dark:text-zinc-500">Every tutor undergoes a strict background check and skills assessment.</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-2xl bg-white dark:bg-white/5 flex items-center justify-center shrink-0 border border-black/10 dark:border-white/10 shadow-sm dark:shadow-none">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 dark:text-zinc-500">Book sessions round the clock, directly accommodating your busy lifestyle.</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div className="flex-1 w-full relative">
              ...
              {/* Floating Card */}
              <div className="absolute -bottom-8 -left-8 md:-bottom-12 md:-left-12 bg-white dark:bg-zinc-900 border border-gray-200 dark:border-white/10 p-6 rounded-2xl shadow-2xl backdrop-blur-xl hidden sm:block">
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex -space-x-3">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="w-10 h-10 rounded-full border-2 border-white dark:border-zinc-900 bg-orange-500" />
                    ))}
                  </div>
                  <div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center text-white max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <Link href="/tutors">
              <button className="bg-transparent border border-white text-white font-bold py-4 px-10 rounded-full hover:bg-white/10 transition-all shadow-[0_4px_14px_0_rgb(0,0,0,39%)] hover:shadow-[0_6px_20px_rgba(0,0,0,0.23)]">
                Explore Tutors
              </button>
            </Link>
          </div>
