    ...
    <div className="py-24 bg-transparent min-h-screen">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400">Effective Date: May 4, 2026</p>
        </div>

        <div className="space-y-8 text-gray-300">
           <div className="p-1 rounded-2xl bg-gradient-to-r from-orange-500/20 to-purple-500/20">
            <div className="bg-[#0a0a14] p-8 rounded-2xl">
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-3">
              <CheckCircle2 className="text-green-500" />
              <h2 className="text-2xl font-bold text-white">3. Tutor-Student Interaction</h2>
            </div>
            <p className="pl-9 leading-relaxed">
