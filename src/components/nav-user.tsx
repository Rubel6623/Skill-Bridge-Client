      ...
      <SidebarMenuItem>
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <SidebarMenuButton
              size="lg"
              className="data-[state=open]:bg-white/10 data-[state=open]:text-white hover:bg-white/5 transition-colors rounded-xl p-2"
            >
              ...
              <div className="grid flex-1 text-left text-sm leading-tight ml-2">
                ...
                <span className="truncate text-[10px] text-white/50 font-medium">{user.email}</span>
              </div>
              <ChevronsUpDown className="ml-auto size-4 text-white/30" />
            </SidebarMenuButton>
          </DropdownMenuTrigger>
          <DropdownMenuContent
            className="w-[var(--radix-dropdown-menu-trigger-width)] min-w-64 rounded-2xl bg-[#0d0d1a] border-white/10 text-white p-2 shadow-2xl backdrop-blur-xl"
            ...
            <DropdownMenuLabel className="p-2 font-normal">
              <div className="flex items-center gap-3 px-1 py-2 text-left">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-black text-base">{user.name}</span>
