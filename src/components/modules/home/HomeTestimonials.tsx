      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-20 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 dark:text-white tracking-tight">
            Loved by <span className="bg-gradient-to-r from-orange-500 to-red-500 dark:from-orange-400 dark:to-red-500 bg-clip-text text-transparent">Thousands</span> of Students
          </h2>
          <p className="text-gray-500 dark:text-white/40 max-w-2xl mx-auto text-lg font-serif">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((item, index) => (
            <div 
              key={index}
              className="relative p-8 rounded-3xl border border-black/5 dark:border-white/5 bg-gradient-to-b from-slate-50 dark:from-white/5 to-transparent backdrop-blur-xl group hover:border-orange-500/20 transition-all duration-500 shadow-md dark:shadow-none"
            >
              ...
              <p className="text-gray-700 dark:text-white/70 italic mb-8 leading-relaxed text-lg font-serif">
                "{item.content}"
              </p>
              ...
              <div className="flex items-center gap-4 pt-6 border-t border-black/5 dark:border-white/5">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-white/30 text-xs uppercase tracking-widest">{item.role}</p>
                </div>
              </div>
            </div>
          ))}
